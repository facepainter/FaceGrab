...
This technique uses a combination of a deep learning CNN model to batch detect faces
...
see notes at - https://gist.github.com/facepainter/adfaabe25831a7c9300bafd1b886e1c8
'''
...
if __name__ == '__main__':
    # Just for example...
    OUTPUT_DIR = r'.\output'
    REF_DIR = r'D:\Documents\deepfake\input\russellcrowe\reference'
    REF_IMG = r'D:\Documents\deepfake\input\russellcrowe\set3\ref.jpg'
    TEST_VIDEO = r'D:\Documents\deepfake\input\russellcrowe\vid\3.mp4'
    # reference can be a path to a single file (eg.  D:\images\someone.jpg)
    # or a path to an directory containing multiple images sequence (e.g.
    # D:\images)
    ...
    FG.process(input_video=TEST_VIDEO, output_directory=r'.\output')
